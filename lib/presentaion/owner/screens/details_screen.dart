...
class ProductDetailsScreen extends StatelessWidget {
  ...
  Widget _buildProductName() {
    return Padding(
      ...
      child: Text(
        product.name,
        style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.darkGolden),
      ),
    );
  }
  ...
  Widget _buildDetails() {
    return Column(
      ...
      children: [
        ...
        if (product.endDate != null) _buildDetailRow('End Date', product.endDate!),
      ],
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            '$label:',
            style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.darkGolden),
          ),
          SizedBox(width: 8),
          Expanded(
            child: Text(
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            'Attributes',
            style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.darkGolden),
          ),
        ),
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              title: Text(attribute.name, style: TextStyle(color: AppColors.darkGray)),
              subtitle: Text(attribute.value, style: TextStyle(color: AppColors.mediumGray)),
