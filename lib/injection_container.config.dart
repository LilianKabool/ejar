...
import 'core/third_party_injection.dart' as _i34;
...
import 'presentaion/order/manager/cubit/rate_product_cubit.dart' as _i32;
import 'presentaion/order/manager/store_order_cubit.dart' as _i33;
...
import 'presentaion/owner/manager/cubit/update_product_cubit.dart' as _i15;
...
import 'presentaion/user/manager/get_full_city_cubit.dart' as _i30;
...
import 'presentaion/user/manager/get_full_currencies_cubit.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i15.UpdateProductCubit>(
        () => _i15.UpdateProductCubit(gh<_i13.OwnerBaseRepository>()));
    gh.factory<_i16.SubscriptionCubit>(
        () => _i16.SubscriptionCubit(gh<_i13.OwnerBaseRepository>()));
    gh.factory<_i17.ProcessingOrdersCubit>(
        () => _i17.ProcessingOrdersCubit(gh<_i13.OwnerBaseRepository>()));
    gh.factory<_i18.SetCardInfoCubit>(
        () => _i18.SetCardInfoCubit(gh<_i13.OwnerBaseRepository>()));
    gh.factory<_i19.MyProductsCubit>(
        () => _i19.MyProductsCubit(gh<_i13.OwnerBaseRepository>()));
    ...
    gh.factory<_i29.GetFullCurrenciesCubit>(
        () => _i29.GetFullCurrenciesCubit(gh<_i24.UserBaseRepository>()));
    gh.factory<_i30.GetFullCityCubit>(
        () => _i30.GetFullCityCubit(gh<_i24.UserBaseRepository>()));
    gh.factory<_i31.GetFullCountryCubit>(
        () => _i31.GetFullCountryCubit(gh<_i24.UserBaseRepository>()));
    gh.factory<_i32.RateProductCubit>(
        () => _i32.RateProductCubit(gh<_i27.OrderBaseRepository>()));
    gh.factory<_i33.StoreOrderCubit>(
        () => _i33.StoreOrderCubit(gh<_i27.OrderBaseRepository>()));
    return this;
  }
}

class _$ThirdPartyInjection extends _i34.ThirdPartyInjection {}
